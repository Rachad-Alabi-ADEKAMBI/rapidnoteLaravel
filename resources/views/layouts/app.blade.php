...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="http://127.0.0.1/rn2/resources/img/ico.ico">
...
<body class="font-sans antialiased">
    ...
    <script type="javascript" src="http://127.0.0.1/rn2/resources/js/script.js"></script>
</body>
